...
//        alert('save data');
        ...
        $scope.db.transaction(function(transaction){
            transaction.executeSql($scope.insertsql, [$scope.username,$scope.lastname, $scope.useremail,$scope.usercemail,$scope.password,$scope.cpassword,$scope.date,$scope.gender,$scope.hobbies, document.getElementById('uploadImg').src],
...
//        alert('show data');
        ...
        $scope.db.transaction(function(transaction){
            transaction.executeSql($scope.selectAllStatement,[],$scope.showRecords);
        });
    };
    $scope.showRecord();
